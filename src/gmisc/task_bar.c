 ...
 *   GLOBAL FUNCTIONS
 **********************/
lv_obj_t * create_phone_icon(lv_obj_t *parent, lv_style_t *icon_style) {
    ...
    lv_obj_align_to(btn_phone, parent, LV_ALIGN_LEFT_MID, 0, 0);
...
lv_obj_t * create_message_icon(lv_obj_t *parent, lv_style_t *icon_style) {
    ...
    lv_obj_align_to(btn_message, parent, LV_ALIGN_LEFT_MID, 117, 0);
...
lv_obj_t * create_toolbox_icon(lv_obj_t *parent, lv_style_t *icon_style) {
    ...
    lv_obj_align_to(btn_toolbox, parent, LV_ALIGN_LEFT_MID, 234, 0);
...
lv_obj_t * create_setting_icon(lv_obj_t *parent, lv_style_t *icon_style) {
    ...
    lv_obj_align_to(btn_setting, parent, LV_ALIGN_LEFT_MID, 351, 0);
...
lv_obj_t * g_create_task_bar(lv_obj_t *parent) {
    ...
    lv_obj_set_size(task_bar, 452, 99);
    ...
    lv_obj_set_style_radius(task_bar, 30, 0);
